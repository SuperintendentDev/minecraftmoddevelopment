...
import net.mcreator.athenamod.entity.model.GiantModel;
...
public class GiantRenderer extends GeoEntityRenderer<GiantEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, GiantEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
