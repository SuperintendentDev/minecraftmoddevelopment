...
public class RocketLauncherProjectileRenderer extends EntityRenderer<RocketLauncherProjectileEntity> {
	...
	@Override
	public void render(RocketLauncherProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
