...
import net.mcreator.athenamod.entity.model.TerroristModel;
...
public class TerroristRenderer extends GeoEntityRenderer<TerroristEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TerroristEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
