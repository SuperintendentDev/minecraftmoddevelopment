...
public class PigEntity extends PathfinderMob {
	public PigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AthenaModModEntities.PIG.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AthenaModModEntities.PIG.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
