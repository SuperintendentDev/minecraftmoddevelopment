...
public class DemonModel extends GeoModel<DemonEntity> {
	...
	public ResourceLocation getAnimationResource(DemonEntity entity) {
		return new ResourceLocation("athena_mod", "animations/demon.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(DemonEntity entity) {
		return new ResourceLocation("athena_mod", "geo/demon.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(DemonEntity animatable, long instanceId, AnimationState animationState) {
