...
public class TerroristModel extends GeoModel<TerroristEntity> {
	...
	public ResourceLocation getAnimationResource(TerroristEntity entity) {
		return new ResourceLocation("athena_mod", "animations/terrorist.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(TerroristEntity entity) {
		return new ResourceLocation("athena_mod", "geo/terrorist.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(TerroristEntity animatable, long instanceId, AnimationState animationState) {
