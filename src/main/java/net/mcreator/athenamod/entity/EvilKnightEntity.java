...
public class EvilKnightEntity extends Animal {
	public EvilKnightEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AthenaModModEntities.EVIL_KNIGHT.get(), world);
	}

	public EvilKnightEntity(EntityType<EvilKnightEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 3;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, KnightEntity.class, false, false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		EvilKnightEntity retval = AthenaModModEntities.EVIL_KNIGHT.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(AthenaModModEntities.EVIL_KNIGHT.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
