...
public class GiantEntity extends Monster implements GeoEntity {
	...
	public GiantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AthenaModModEntities.GIANT.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, KnightEntity.class, false, false));
		...
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, DeermanEntity.class, false, false));
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, MrDuckEntity.class, false, false));
	...
	public static void init() {
		SpawnPlacements.register(AthenaModModEntities.GIANT.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				return event.setAndContinue(RawAnimation.begin().thenLoop("giantwalk"));
			}
			return event.setAndContinue(RawAnimation.begin().thenLoop("giantidle"));
		}
