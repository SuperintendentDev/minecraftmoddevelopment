...
public class GhostLayer extends GeoRenderLayer<GhostEntity> {
	private static final ResourceLocation LAYER = new ResourceLocation("athena_mod", "textures/entities/bulletmodeltexture.png");

	public GhostLayer(GeoRenderer<GhostEntity> entityRenderer) {
