...
package net.mcreator.athenamod.world.dimension;
...
public class ForgottenLandsDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("athena_mod:forgotten_lands"), customEffect);
		}
	}
}
