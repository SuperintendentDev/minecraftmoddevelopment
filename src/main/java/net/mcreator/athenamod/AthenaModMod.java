 ...
 *
 */
package net.mcreator.athenamod;
...
@Mod("athena_mod")
public class AthenaModMod {
	public static final Logger LOGGER = LogManager.getLogger(AthenaModMod.class);
	public static final String MODID = "athena_mod";

	public AthenaModMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		AthenaModModSounds.REGISTRY.register(bus);
		AthenaModModBlocks.REGISTRY.register(bus);
		AthenaModModBlockEntities.REGISTRY.register(bus);
		AthenaModModItems.REGISTRY.register(bus);
		...
		AthenaModModMenus.REGISTRY.register(bus);
	}
